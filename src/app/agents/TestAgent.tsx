...
export function TestAgent({ agentId, agentName }: { agentId: string; agentName: string }) {
    return (
        <div className="max-w-5xl mx-auto p-6">
            <Card className="bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 shadow-lg">
                ...
                <CardContent>
                    <div className="flex flex-col h-[70vh] items-center p-6">
                        ...
                        <div className="h-[200px] w-[150px] mx-auto animate-fade-in">
