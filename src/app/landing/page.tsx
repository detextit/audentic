            ...
            <header className="border-b">
                <div className="container mx-auto px-6 h-16 flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                        <img src="/icon.png" alt="Audentic Icon" className="h-6 w-6" />
            ...
            <main>
                        ...
                        <div className="flex flex-col lg:flex-row items-center gap-8">
                            <div className="lg:w-1/2 space-y-6">
                                ...
                                <p className="text-xl text-muted-foreground">
                                    Create, test, and integrate AI voice agents into your applications.
                                </p>
                ...
                <section className="container mx-auto px-6 py-16">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-muted-foreground">New features to make your agents even more powerful</p>
                    </div>
                    <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Configure and add your own tools to enhance your agent's capabilities
                                </CardDescription>
                            </CardHeader>
                        </Card>
                        <Card>
                ...
                <section className="border-t bg-slate-900 text-white">
                    <div className="container mx-auto px-6 py-16 text-center items-center justify-center">
                        ...
                        <div className="flex justify-center">
                            <SessionControl agentId="voiceact" />
                        </div>
                    </div>
                </section>
            </main>
