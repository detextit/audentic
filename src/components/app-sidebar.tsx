...
export function AppSidebar({ setSelectedItem }: { setSelectedItem: (item: string) => void }) {
  ...
  return (
    <Sidebar
      collapsible="none"
      className="!w-[calc(var(--sidebar-width-icon)_+_1px)] border-r flex-shrink-0 flex h-screen"
    >
      <SidebarHeader>
        <SidebarMenu>
          <SidebarMenuItem>
